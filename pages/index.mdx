...
Hey, I'm a backend developer at [Ilium](https://ilium.co). I mainly build APIs, work with databases and many other backend related tasks using Typescript, Golang, SQL and other languages.
